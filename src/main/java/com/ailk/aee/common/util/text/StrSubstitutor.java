...
package com.ailk.aee.common.util.text;
...
@CVSID("$Id: StrSubstitutor.java 60270 2013-11-03 14:48:37Z tangxy $")
public class StrSubstitutor
{
    ...
    public static <V> String replace(final Object source, final Map<String, V> valueMap) {
        return new StrSubstitutor((Map<String, String>)valueMap).replace(source);
    }
    
    public static <V> String replace(final Object source, final Map<String, V> valueMap, final String prefix, final String suffix) {
        return new StrSubstitutor((Map<String, String>)valueMap, prefix, suffix).replace(source);
    }
