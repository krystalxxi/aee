...
@CVSID("$Id: StringUtils.java 60270 2013-11-03 14:48:37Z tangxy $")
public class StringUtils
{
    ...
    private static class InitStripAccents
    {
        ...
        static {
            ...
            java6Pattern = InitStripAccents.sunPattern;
            ...
            try {
                ...
                _java6Exception = e1;
                try {
                    final Class<?> normalizerClass = Thread.currentThread().getContextClassLoader().loadClass("sun.text.Normalizer");
