...
@CVSID("$Id: FastDateFormat.java 60270 2013-11-03 14:48:37Z tangxy $")
public class FastDateFormat extends Format
{
    ...
    public static FastDateFormat getDateInstance(final int style) {
        return FastDateFormat.cache.getDateTimeInstance(style, null, null, null);
    }
    
    public static FastDateFormat getDateInstance(final int style, final Locale locale) {
        return FastDateFormat.cache.getDateTimeInstance(style, null, null, locale);
    }
    
    public static FastDateFormat getDateInstance(final int style, final TimeZone timeZone) {
        return FastDateFormat.cache.getDateTimeInstance(style, null, timeZone, null);
    }
    
    public static FastDateFormat getDateInstance(final int style, final TimeZone timeZone, final Locale locale) {
        return FastDateFormat.cache.getDateTimeInstance(style, null, timeZone, locale);
    }
    ...
    public static FastDateFormat getTimeInstance(final int style) {
        return FastDateFormat.cache.getDateTimeInstance(null, style, null, null);
    }
    
    public static FastDateFormat getTimeInstance(final int style, final Locale locale) {
        return FastDateFormat.cache.getDateTimeInstance(null, style, null, locale);
    }
    
    public static FastDateFormat getTimeInstance(final int style, final TimeZone timeZone) {
        return FastDateFormat.cache.getDateTimeInstance(null, style, timeZone, null);
    }
    
    public static FastDateFormat getTimeInstance(final int style, final TimeZone timeZone, final Locale locale) {
        return FastDateFormat.cache.getDateTimeInstance(null, style, timeZone, locale);
    }
    ...
    static String getTimeZoneDisplay(final TimeZone tz, final boolean daylight, final int style, final Locale locale) {
        ...
        if (value == null) {
            ...
            final String prior = FastDateFormat.cTimeZoneDisplayCache.putIfAbsent(key, value);
            if (prior != null) {
                value = prior;
            }
        }
    ...
    static {
        ...
        FastDateFormat.cTimeZoneDisplayCache = new ConcurrentHashMap<TimeZoneDisplayKey, String>(7);
    }
