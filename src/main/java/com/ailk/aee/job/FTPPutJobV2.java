...
@CVSID("$Id: FTPPutJobV2.java 10855 2013-05-24 09:57:46Z xiezl $")
public class FTPPutJobV2 extends FTPPutJob
{
    ...
    public void execute(final IJobSession ctx) throws Exception {
        if (!this.isInit) {
            ...
            if (list != null && list.size() > 0) {
                ...
                this.setLocalPathHis(temp.get("LOCAL_PATH_HIS"));
                this.setRemotePath(temp.get("REMOTE_PATH"));
                this.setRemotePathTemp(temp.get("REMOTE_PATH_TEMP"));
